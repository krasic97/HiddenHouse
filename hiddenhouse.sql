...
INSERT INTO `commands` VALUES (1,'END'),(2,'INVENTORY'),(3,'NORD'),(4,'SOUTH'),(5,'EAST'),(6,'WEST'),(7,'OPEN'),(8,'CLOSE'),(9,'PUSH'),(10,'PULL'),(11,'WALK'),(12,'PICK_UP'),(13,'TALK'),(14,'GIVE'),(15,'USE'),(16,'LOOK'),(17,'TURN_ON'),(18,'TURN_OFF'),(19,'BACK'),(20,'SAVE'),(21,'LOAD'),(22,'CUT'),(23,'INSERT'),(24,'ACTUATE'),(25,'CLIMB');
...
INSERT INTO `game_logic` VALUES (1,'WEST',NULL,NULL,NULL),(2,'OPEN','SETTLE',NULL,11),(3,'PICK_UP','ORANGE_CRYSTAL',NULL,NULL),(4,'PICK_UP','RADIO',NULL,NULL),(5,'USE','ORANGE_CRYSTAL','RADIO',15),(6,'NORTH',NULL,NULL,NULL),(7,'LOOK','ALTAR',NULL,17),(8,'PICK_UP','HANDLE',NULL,NULL),(9,'OPEN','DOOR','HANDLE',79),(10,'NORTH',NULL,NULL,NULL),(11,'ACTUATE','WEST_GEAR',NULL,24),(12,'WEST',NULL,NULL,NULL),(13,'PUSH','BUTTON','TABLE_LEG',29),(14,'CUT','IVY','KNIFE',32),(15,'EAST',NULL,NULL,NULL),(16,'OPEN','DRAWER',NULL,35),(17,'OPEN','CUPBOARD','KEY',36),(18,'NORTH',NULL,NULL,NULL),(19,'PICK_UP','GREEN_CRYSTAL',NULL,NULL),(20,'USE','GREEN_CRYSTAL','RADIO',39),(21,'NORTH',NULL,NULL,41),(22,'POUR','JAR','GHOST',43),(23,'ACTUATE','MIRROR',NULL,46),(24,'EAST',NULL,NULL,NULL),(25,'OPEN','WARDROBE',NULL,50),(26,'INSERT','EARRING','PAINTING',51),(27,'EAST',NULL,NULL,NULL),(28,'CUT','ROPE','SPEAR',58),(29,'WEST',NULL,NULL,59),(30,'CLIMB','LADDER',NULL,60);
...
INSERT INTO `rooms` VALUES (1,'stanza con stella dei venti',NULL,NULL,1,2,3),(2,'stanza a forma di ottagono',NULL,3,NULL,4,7),(3,'stanza segreta',5,6,NULL,NULL,11),(4,'stanza con altare',7,NULL,8,NULL,16),(5,'stanza del prete',10,NULL,NULL,9,19),(6,'stanza ellittica',NULL,11,12,NULL,21),(7,'vecchia cucina',NULL,14,NULL,13,26),(8,'stanza vegetazione',15,NULL,NULL,16,30),(9,'stanza da pranzo',18,NULL,17,NULL,33),(10,'stanza del fantasma',20,19,NULL,NULL,38),(11,'grande soggiorno',NULL,21,NULL,22,44),(12,'stanza con affresco',NULL,NULL,23,24,47),(13,'stanza delle armature',NULL,26,25,NULL,53),(14,'stanza delle armi',27,NULL,28,NULL,55);
...
-- Dump completed on 2020-06-18 18:49:50
